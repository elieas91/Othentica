...
const Security = () => {
  ...
  const truncateDescription = (description) => {
    ...
    const textDescription = typeof description === 'string' ? description : String(description);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {securityData.map((security) => {
            const { truncated, needsTruncation } = truncateDescription(security.description);
              ...
              >
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="text-primary dark:text-gray-200 mb-8 leading-relaxed">
                    <span>
                      {isExpanded ? (typeof security.description === 'string' ? security.description : String(security.description)) : truncated}
                    </span>
                    {needsTruncation && (
                      <button
