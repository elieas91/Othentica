...
const CalendarBooking = ({ className = '' }) => {
  ...
  return (
    <>
      ...
      <button
        onClick={openModal}
        className={`${className} bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center transition-colors shadow-lg hover:shadow-xl`}
