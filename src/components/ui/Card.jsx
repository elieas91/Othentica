...
const Card = ({ children, className = '', showHoverShadow = true }) => {
  let cardClassName = `rounded-2xl p-6 transition-all duration-300 flex flex-col relative overflow-hidden ${className}`;
  if (showHoverShadow) {
    cardClassName += ' hover:shadow-professional hover:shadow-xl-professional';
  }
  return (
