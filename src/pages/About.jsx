...
const About = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      {/* Hero Section - Large */}
      <section className="py-24 px-8 lg:px-16 bg-gradient-to-br from-pink-50 to-pink-100 dark:from-gray-900 dark:to-gray-800">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <h1 className="text-5xl lg:text-6xl font-bold text-blue-900 dark:text-white leading-tight">
                We believe wellness equals happiness.
              </h1>
              <p className="text-xl lg:text-2xl text-blue-900 dark:text-gray-200 leading-relaxed">
      ...
      <section id="mission" className="py-16 px-8 lg:px-16 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-blue-900 dark:text-white mb-6">Our Mission</h2>
          <p className="text-xl text-blue-900 dark:text-gray-200 leading-relaxed max-w-3xl mx-auto">
      ...
      <section id="vision" className="py-24 px-8 lg:px-16 bg-pink-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <section id="values" className="py-16 px-8 lg:px-16 bg-white dark:bg-gray-900">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-blue-900 dark:text-white mb-6">Our Core Values</h2>
            <p className="text-xl text-blue-900 dark:text-gray-200 leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-pink-50 dark:bg-gray-800 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-blue-900 dark:text-white mb-4">Authenticity</h3>
            ...
            <div className="text-center p-8 bg-pink-50 dark:bg-gray-800 rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-blue-900 dark:text-white mb-4">Balance</h3>
              <p className="text-blue-900 dark:text-gray-200 leading-relaxed">
            ...
            <div className="text-center p-8 bg-pink-50 dark:bg-gray-800 rounded-2xl">
              <div className="text-5xl mb-4">🌱</div>
              <h3 className="text-2xl font-bold text-blue-900 dark:text-white mb-4">Growth</h3>
              <p className="text-blue-900 dark:text-gray-200 leading-relaxed">
      ...
      {/* Story Section - Large */}
      <section className="py-24 px-8 lg:px-16 bg-gradient-to-br from-pink-100 to-pink-50 dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Left Side - Large Image */}
            <div className="relative">
      ...
      {/* CTA Section - Small */}
      <section className="py-16 px-8 lg:px-16 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-blue-900 dark:text-white mb-6">Ready to Start Your Journey?</h2>
          <p className="text-xl text-blue-900 dark:text-gray-200 leading-relaxed mb-8">
